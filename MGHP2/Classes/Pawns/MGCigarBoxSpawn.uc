class MGCigarBoxSpawn extends MGSpawner;
...
defaultproperties
{
    ...
    OpeningSound=Sound'HPSounds.General.spawner_cigar_box'
    ...
    DrawScale=2
    CollisionRadius=33.70578
    CollisionWidth=33.70578
    CollisionHeight=72.5443
